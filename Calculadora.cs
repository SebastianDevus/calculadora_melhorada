public class Calculadora
{
    public static void CalcularSoma()
    {
        ...
        resultado = Aritmetica.RealizaSoma(a, b);
    ...
    public static void CalcularSubtracao()
    {
        ...
        resultado = Aritmetica.RealizaSubtracao(a, b);
    ...
    public static void CalcularMultiplicacao()
    {
        ...
        resultado = Aritmetica.RealizaMultiplicacao(a, b);
    ...
    public static void CalcularDivisao()
    {
        ...
        {
            resultado = Aritmetica.RealizaDivisao(a, b);
